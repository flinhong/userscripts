...
function bumpVersion(type) {
  ...
  if (dryrun) {
    console.log(
      `[Dry Run] Would bump version from ${versionConfig.version} to ${newVersion}`,
    )
  } else {
...
function resetVersion() {
  ...
  if (dryrun) {
    console.log(
      `[Dry Run] Would reset version to 1.0.0 (current: ${currentVersion})`,
    )
  } else {
...
switch (action) {
  ...
  default:
    console.log('Usage:')
    console.log(
      '  node scripts/release.js bump <type>    - Bump version and build (major, minor, patch)',
    )
    console.log(
      '  node scripts/release.js reset          - Reset version to 1.0.0 and build',
    )
    console.log(
      '  node scripts/release.js build-only     - Build public directory only',
    )
    console.log('')
    console.log('Options:')
